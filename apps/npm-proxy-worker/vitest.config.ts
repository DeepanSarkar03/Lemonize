    ...
    cloudflareTest({
      ...
      miniflare: {
        bindings: {
          ...
          NPM_ORIGIN_CLIENT_METADATA_MINUTE: '2',
          NPM_ORIGIN_CLIENT_METADATA_DAY: '3',
          NPM_ORIGIN_CLIENT_SEARCH_MINUTE: '1',
          NPM_ORIGIN_CLIENT_SEARCH_DAY: '2',
          NPM_ORIGIN_CLIENT_AUDIT_MINUTE: '1',
          NPM_ORIGIN_CLIENT_AUDIT_DAY: '2',
          NPM_ORIGIN_CLIENT_TARBALL_MINUTE: '1',
          NPM_ORIGIN_CLIENT_TARBALL_DAY: '2',
        },
      },
    }),
  ],

...
| -------------------------------------------------------------- | ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Production Clerk DNS and GitHub OAuth are incomplete           | The production browser identity and public-publisher path cannot launch | Add the five pending DNS records, verify SSL/mail, create the GitHub OAuth client, configure its callback/secret in Clerk, and test login, lockout, linking, and device approval |
